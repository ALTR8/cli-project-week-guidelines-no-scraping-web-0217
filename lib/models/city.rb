...
"
  ...
  def explanation
    puts "!L = Listing mode
    => list weather details for a location"
    puts "!C = Comparison mode
    => compare weather from different locations"
    puts "!help = help file"
    puts "!R = to restart your search"
    puts "!exit = exit"
    puts "Input locations as a normal street address
                   or a city state or city country"
  end
